    ...
    switch(initScale){
        ...
        case 3:
            ...
            // Fahrenheit to Kelvin
                ...
                finalValue = ((initValue - 32) * 5 / 9) + 273,15;   //// 273.15
            }
            break;
...
int main(){
    ...
    while(1){
        ...
        switch(option){ //// почему бы не впихнуть всё в функцию?
            case 1:
            ...
            case 5:
                ...
                break;
            case 6:
                finalValue = convertTemp(initialValue,3,1); //// вот тут (..., 3, 2)
                printf("Valor em Kelvin: %.2lf",finalValue);
                break;
